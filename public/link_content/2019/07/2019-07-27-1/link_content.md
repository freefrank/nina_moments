...
**链接地址:** http://mp.weixin.qq.com/s?__biz=MzIyMjY3MDI5MA==&mid=2247485819&idx=1&sn=f75e0b0f1c3a456568e1bd937325b6bb&chksm=e828b5c6df5f3cd0bd2fce891f423430080ae2da42790e635ba40bdd09dd5fde5363200d3037&mpshare=1&scene=2&srcid=07279Bdy2G9DTdKI6wme3M5s&sharer_sharetime=1564196934183&sharer_shareid=be1c8edd6c93eec155a61c876e41d26a#rd
**作者:** 
**获取时间:** 2025/8/28 20:30:40
**图片数量:** 0
...
<div class="weui-msg">
    ...
    <div class="weui-msg__text-area">
                <h3 class="weui-msg__title">此内容被投诉且经审核涉嫌侵权，无法查看。</h3>
            <div class="weui-msg__custom-desc">
        <div class="weui-form-preview__list">
            <div class="weui-form-preview__item">
                <label for="" class="weui-form-preview__label">被投诉内容</label>
                <p class="weui-form-preview__value">北美留学生日报：强奸文化的帮凶</p>
            </div>
            <div class="weui-form-preview__item">
                <label for="" class="weui-form-preview__label">投诉类型</label>
                <p class="weui-form-preview__value">
                侵犯名誉/商誉/隐私/肖像
                                </p>
            </div>
            <div class="weui-form-preview__item">
                <label for="" class="weui-form-preview__label">审核依据</label>
                                <p class="weui-form-preview__value faq-link">
                    <a href="https://mp.weixin.qq.com/mp/opshowpage?action=newoplaw#t3-4-1">《微信公众平台运营规范》第4.1条规定</a>
                                        <a href="/mp/readtemplate?t=appmsg/infringement_legal_tmpl&amp;type=90010">主要法律法规</a>
                                    </p>
                            </div>
        </div>
        <div class="weui-form-preview__list">
            <div class="weui-form-preview__item">
                <label for="" class="weui-form-preview__label">了解更多</label>
                <p class="weui-form-preview__value">
                  <span class="faq-link">
                      <a href="http://kf.qq.com/faq/170113jemA7r170113iYB7fy.html">侵权行为及处罚介绍</a>
                  </span>
                  <span class="faq-link">
                      <a href="http://kf.qq.com/faq/170113QF7BVJ170113NvAJvA.html">侵权疑难解答汇总</a>
                  </span>
                  <span class="faq-link">
                      <a href="http://kf.qq.com/faq/170113Vb6fYb170113ZfEVNB.html">侵权投诉审核标准</a>
                  </span>
                </p>
            </div>
        </div>
    ...
    <div class="weui-msg__extra-area">
        <div class="weui-footer">
            <p class="weui-footer__links">
                                <a class="weui-footer__link" href="http://kf.qq.com/faq/171211F3YNNj171211ZBNrUb.html">我要申诉</a>
...
<script type="text/javascript" nonce="" reportloaderror="">
    window.cgiData = {
        del_reason_id: '90010',
        del_reason: '涉嫌侵犯名誉/商誉/隐私/肖像',
        user_name: 'gh_c371f431b86a',
        nick_name: '反吃瓜联盟',
    };
</script>
...
<script nomodule="" crossorigin="" id="vite-legacy-entry" data-src="//res.wx.qq.com/mmbizappmsg/zh_CN/htmledition/js/assets/infringement-legacy.mevbdinz3445c87d.js" nonce="" reportloaderror="">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
